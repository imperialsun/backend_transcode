...
func (s *Store) Migrate(ctx context.Context) error {
	stmts := []string{
		...
		`CREATE INDEX IF NOT EXISTS idx_mobile_operations_owner ON mobile_operations(organization_id, user_id);`,
		`CREATE INDEX IF NOT EXISTS idx_mobile_operations_status ON mobile_operations(status, terminal_expires_at);`,
